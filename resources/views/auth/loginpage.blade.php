        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-5">
                    @isset($error_msg)
                    <!--  if the user name & password does not match then this msg show -->
                    ...
                    @endisset
                    <div class="wrap">
                        <div class="img" style="background-image: url(admin_img/excavator.jpg);"></div>
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form method="POST" action="{{ url('login_url') }}" class="signin-form">
                                @csrf
