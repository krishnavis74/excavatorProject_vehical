    ...
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-sm-6">
                ...
                {!! Form::button('<i class="fa fa-desktop "></i> Dash Board / <b>Vehicle</b>', ['class' => 'btn btn-primary','style'=>'color:white;']) !!}
            ...
            <div class="col-sm-6">
                <div class="float-right">
                    <a href="{{ route('add_vehicle') }}">
                        <button type="button" class="btn btn-primary" id="add_btn" style="float:right ;  "><i class="fa fa-plus-circle"></i> &nbsp;add Vehicle &nbsp;</button>
                    </a>
                </div>
            </div><!-- /.col -->
        </div><!-- /.row -->
...
<script>
    ...
    $("#vehicle_table").on('draw.dt', function() {
        $(".edit_data").click(function() {
            ...
            redirectPost("{{ url('edit_vehicle') }}", datas);
        ...
        //         content: "Are You Sure To Active Data",
        //         buttons: {
        //             yes: function() {
        ...
        //                                 icon: 'fa fa-check',
        //                                 title: 'Success!!',
        //                                 content: '<strong>SUCCESS:</strong> Result Active successfully.'
        //                             });
        //                         } else {
        //                             $.alert({
        //                                 type: 'red',
        //                                 icon: 'fa fa-warning',
        //                                 title: 'Error!!',
        //                                 content: '<strong>SUCCESS:</strong> Failed to Active data.'
        //                             });
        //                         }
        //                     },
        ...
        //         type: 'orange',
        //         icon: 'fas fa-exclamation-triangle',
        //         content: "Are You Sure To Inactive Data",
        //         buttons: {
        //             yes: function() {
        ...
        //                                 icon: 'fa fa-check',
        //                                 title: 'Success!!',
        //                                 content: '<strong>SUCCESS:</strong>Result Inactive successfully.'
        //                             });
        //                         } else {
        //                             $.alert({
        //                                 type: 'red',
        //                                 icon: 'fa fa-warning',
        //                                 title: 'Error!!',
        //                                 content: '<strong>SUCCESS:</strong> Failed to Inactive data.'
        //                             });
        //                         }
        //                     },
        //                     error: function(jqXHR, textStatus, errorThrown) {
